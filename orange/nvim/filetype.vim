...
" C or lpc
au BufNewFile,BufRead *.c			call s:CType()
au BufNewFile,BufRead *.lpc,*.ulpc		setf lpc
function! s:CType()
        call dist#ft#FTlpc()
	set makeprg=gcc\ -Wall\ -pedantic\ -\Wshadow\ -Wextra\ -std=c17\ -o\ %:r\ %
endfunction
...
" C++
au BufNewFile,BufRead *.cxx,*.c++,*.hh,*.hxx,*.hpp,*.ipp,*.moc,*.tcc,*.inl call s:CppType()
if has("fname_case")
  au BufNewFile,BufRead *.C,*.H call s:CppType()
endif
function! s:CppType()
        setf cpp
	set makeprg=g++\ -Wall\ -pedantic\ -\Wshadow\ -Wextra\ -std=c++20\ -o\ %:r\ %
endfunction
...
au BufNewFile,BufRead *.py,*.pyw,.pythonstartup,.pythonrc,*.ptl,*.pyi  call s:PyType()
function! s:PyType()
        setf python
...
au BufNewFile,BufRead *.tex			call s:TexType()
function! s:TexType()
	call dist#ft#FTtex()
